...
Данный проект разработан для международного конкурса «Большие вызовы» (2026) и вызвал практический интерес у **АО «Томинский горно-обогатительный комбинат»** (ГОК «Томинский») — одного из крупнейших производителей медного концентрата в России, ведущего открытую добычу руды.[web:1][web:5][web:9]

Это решение автоматизирует процесс геотехнического мониторинга: от создания ортофотоплана до детекции трещин, разломов и тепловых аномалий, значительно повышая безопасность и эффективность маркшейдерских работ.[web:3][web:4]
...
- **Нейросетевой анализ:** Обнаружение и локализация дефектов (трещин) на ортофотоплане с помощью модели YOLOv8.[web:4][web:14]
