...
Разработан для международного конкурса **«Большие вызовы»** (2026) и вызвал практический интерес у **АО «Томинский горно-обогатительный комбинат»** (ГОК «Томинский») — одного из крупнейших производителей медного концентрата в России.  
Компания ведёт добычу и переработку руды открытым способом, уделяя особое внимание промышленной безопасности и мониторингу состояния бортов карьера.  
Наше решение автоматизирует этот процесс: от создания ортофотоплана до поиска трещин с помощью нейросетей.
...
3. Экспорт	JPG + OBJ	Готовые данные
...
Использование
Перетащите папку с фотографиями (до 2 ГБ) в область загрузки.
